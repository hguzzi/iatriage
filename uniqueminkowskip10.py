# -*- coding: utf-8 -*-
"""uniqueMinkowskip10.ipynb

Automatically generated by Colaboratory.

Original file is located at
    https://colab.research.google.com/drive/1gkmAwkjjCdjcE8baIqBQxtPwb_7cGsUm
"""
...
def graph_by_min_dist(df, threshold):
    ...
    m = pairwise_distances(df, metric='minkowski', p=10)
    scaler = MinMaxScaler()
    m_norm = scaler.fit_transform(m)
    n=len(df.index)
    # Add an edge if the distance < t.
    for i in range(n):
...
def graph_torch(df, threshold, y):
  ...
  print(start)
  G = graph_by_min_dist(df, threshold)
  print('end creation')
